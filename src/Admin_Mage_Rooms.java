 ...
 * @author danis
 */
public class Admin_Mage_Rooms extends javax.swing.JFrame {

    /**
     * Creates new form Admin_Mage_Rooms
     */
    ArrayList<Rooms> arrayList  = new ArrayList<>();
    MyTabelModel tm = new MyTabelModel();
    public Admin_Mage_Rooms() {
        initComponents();
        setSize(500,500);
        setVisible(true);
          j_rooms.setModel(tm);
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(120, 10, 452, 300);
        ...
        jButton1.setBounds(260, 340, 170, 50);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_Mage_Rooms.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Admin_Mage_Rooms().setVisible(true);
            }
        });
    }
